<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="panel panel-default">
        <div style="float:right; text-align: right;padding-top: 2px; margin-right:5px" ><a href="<?=site_url('admins/newAccessory')?>" class='btn btn-default'>Add New</a></div>
        ...
        <div class="panel-body">
            ...
            if(!empty($accessory_list)) {
                ...
                <div style="height:1em; font-size:14px;">
                    ...
                    <div style="float:left; margin-right: 20px;"><b>Type</b></div>
                    <div style="float:right;"><b>Price &nbsp;</b></div>
                </div>
                <br>

                <?php
                foreach ($accessory_list as $key => $value) {
                    $id = 0;
                    $name = "";
                    $type="";
                    $price = "";
                                ...
                                <a href="#msg_<?php echo $id; ?>" role="button" data-toggle="collapse"
                                   data-parent="#accordion" aria-expanded="false" aria-controls="msg_<?php echo $id; ?>">
                                    <div style="height:1em; font-size:14px;">
                                        ...
                                        <div style="float:left; margin-right: 20px;"><?php echo $type; ?></div>
                        ...
                        <div class="panel-collapse collapse" id="msg_<?php echo $id; ?>" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <div class='thumbnail col-lg-offset-4 col-lg-2'>
                                    ...
                                    $temp = $path . 'thumb/'.'thumb_acc' . $id . '_' . $filename;
                                    echo $temp;
                                    ?>">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-default"
                                       href="<?=site_url('admins/editAccessory/'.$id)?>">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a class="btn btn-default" onclick="return confirm('Are you sure to delete?')"
                                       href="<?=site_url('admins/removeAccessory').'/'.$id.'/'.$filename?>">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
