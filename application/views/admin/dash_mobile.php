<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="panel panel-default">
        <div style="float:right; text-align: right;padding-top: 2px; margin-right:5px" ><a href="<?=site_url('admins/newMobile')?>" class='btn btn-default'>Add New</a></div>
                        ...
                        <div class="panel-collapse collapse" id="msg_<?php echo $id; ?>" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <div class='thumbnail col-lg-offset-4 col-lg-2'>
                                    ...
                                    $temp = $path . 'thumb/'. 'thumb_mob' . $id . '_' . $filename;
                                    echo $temp;
                                    ?>">
                                ...
                                <div class="pull-right">
                                    <a class="btn btn-default"
                                       href="<?=site_url('admins/editMobile/'.$id)?>">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a class="btn btn-default" onclick="return confirm('Are you sure to delete?')"
                                       href="<?=site_url('admins/removeMobile/').'/'.$id.'/'.$filename?>">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
