...
<div class="panel panel-default col-lg-offset-4 col-lg-4">
    ...
    <form action="<?=site_url("home_handle/loginPage");?>" method="post" name="frmUserLogin">
        ...
        <div class="panel-footer">
            ...
            <a href="<?=site_url('home_handle/signup/user')?>" class="pull-right">Haven't signed up yet? Sign up here!</a>
        </div>
    </form>
</div>
