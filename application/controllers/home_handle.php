...
class Home_Handle extends CI_Controller {
	...
	public function getItemsList($page) {
	...
	public function index()
	{
		...
		$this->load->view('Join/content',$data);
	...
	public function loadPage($page='home')
	{
		switch($page)
		{
			...
			case "mobile":{
				...
				$this->load->view('header',$data);
				$this->load->view('Join/mobile',$data);
				$this->load->view('footer');
				break;
			}
			case "tablet": {
				...
				$data['items'] = $this->item->getAll($page);
				$this->load->view('header',$data);
				$this->load->view('Join/tablet',$data);
				$this->load->view('footer');
				break;
			}
			case "accessory": {
				...
				$data['items'] = $this->item->getAll($page);
				$this->load->view('header',$data);
				$this->load->view('Join/accessory',$data);
				$this->load->view('footer');
				break;
			}
			case "new_release": {
				...
				$data['items'] = $this->item->getAll($page);
				$this->load->view('header',$data);
				$this->load->view('Join/new_release',$data);
				$this->load->view('footer');
				break;
			}
		};
